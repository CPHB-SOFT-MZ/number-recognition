...
W5 = tf.Variable(tf.truncated_normal([28*28, 300], stddev=0.1))
B5 = tf.Variable(tf.ones(300))

W4 = tf.Variable(tf.truncated_normal([300, 200], stddev=0.1))
...
B2 = tf.Variable(tf.ones(60))

W1 = tf.Variable(tf.truncated_normal([60, 30], stddev=0.1))
...
# The model
Y5 = tf.nn.relu(tf.matmul(XX, W5) + B5)
Y5d = tf.nn.dropout(Y5, pkeep)
Y4 = tf.nn.relu(tf.matmul(Y5d, W4) + B4)
Y4d = tf.nn.dropout(Y4, pkeep)
Y3 = tf.nn.relu(tf.matmul(Y4d, W3) + B3)
Y3d = tf.nn.dropout(Y3, pkeep)
Y2 = tf.nn.relu(tf.matmul(Y3d, W2) + B2)
Y2d = tf.nn.dropout(Y2, pkeep)
Y1 = tf.nn.relu(tf.matmul(Y2d, W1) + B1)
Y1d = tf.nn.dropout(Y1, pkeep)
Ylogits = tf.matmul(Y1d, W) + b
